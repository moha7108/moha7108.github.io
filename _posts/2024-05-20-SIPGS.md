...
<style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; display: flex; justify-content: center; align-items: center; } .embed-container img { position: absolute; max-width: 100%; height: auto; }</style><div class='embed-container'><img src='https://i.imgur.com/wXPghgg.gif' alt='Description'></div>
